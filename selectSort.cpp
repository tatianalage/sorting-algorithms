...
void unoptimizedSelectSort(Node **head);
void optimizedSelectSort(Node **head);
...
int main()
{
    ...
    for (int size : sizes)
    {
       ...
       // Calculating mean
        ...
        cout << "Unoptimized Select Sort:" << endl;
        ...
        cout << endl;
        cout << "Optimized Select Sort:" << endl;
